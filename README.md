...
Unlike synthetic or classroom datasets, this project uses real operational POS data
with incomplete documentation, inconsistent text, refunds, bundles, and human error.

The analysis demonstrates how analytics must adapt to imperfect business data —
not the other way around — while still producing executive-grade, auditable insights.

This mirrors the type of data challenges faced in real retail, service, and operations
analytics roles.
...
- Pricing tier behavior analysis ($100–$200 gap identification)
